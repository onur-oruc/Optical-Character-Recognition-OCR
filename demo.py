...
stlit.title("OCR tool to detect texts on logos and images in user emails")
stlit.markdown("Welcome to the demo.")
# -- Heroku Deployment --
...
option = stlit.selectbox("Choose your method: ", options)
